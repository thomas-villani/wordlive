...
Flags and exit codes that apply to every invocation.
...
Read-only probes that report what the document is and where things sit.
...
Pull text out of the document — by anchor, by section, or whole-document serialisations.
...
Locate text, then move the cursor or the view.
...
Insert, replace, and delete paragraphs and blocks.
...
Apply paragraph/character formatting and manage styles.
...
Apply, inspect, and author list formatting.
...
Create, read, and restructure tables.
...
## Bookmarks, pins & links

Named anchors, durable pins, hyperlinks, cross-references, and captions.
...
Create and edit structured fill-in fields.
...
Self-updating fields, notes, and the tables built from them (TOC, figures, index).
...
Sources, in-text citations, and the bibliography / table of authorities.
...
Read and apply the document-wide colour/font theme.
...
## Images, shapes & objects

Pictures, watermarks, text boxes, floating shapes, equations, and charts.
...
Section layout, page setup, and header/footer content.
...
Review comments plus tracked-change recording and resolution.
...
Fingerprint the document and diff what changed.
...
## Hyperlinks & field discovery

Read mirrors of the links and fields already in the document.
...
Built-in/custom properties and document variables.
...
Render pages to PNG and save / export.
...
Run many ops in one atomic-undo round-trip.
...
The about screen, the bundled LLM skill, installers, and a worked example.
